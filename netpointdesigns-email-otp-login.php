 ...
 * Plugin URI:  https://github.com/modkore/Email-OTP-Login-Wordpress-Plugin/
 * Description: Adds a second login step with a 6-digit email OTP; apply to all users or only admins.
 * Version:     1.0.0
 * Author:      Joseph Pausal (NetPointDesigns)
 * Author URI:  https://netpointdesigns.com/
 * Text Domain: netpointdesigns-email-otp-login
...
class EOL_Email_OTP_Login {
    ...
    public function add_settings_page() {
        add_options_page(
            esc_html__( 'NetPointDesigns Email OTP', 'email-otp-login' ),
            esc_html__( 'NetPointDesigns Email OTP', 'email-otp-login' ),
            'manage_options',
            'eol-otp',
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            <h1><?php echo esc_html__( 'NetPointDesigns Email OTP', 'email-otp-login' ); ?></h1>
